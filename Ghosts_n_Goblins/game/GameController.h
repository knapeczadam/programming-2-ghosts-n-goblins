...
public:
    ...
    inline void Test() const
    {
        ...
        assert(m_pInitialDrawer != nullptr and "GameController::Test() m_pInitialDrawer is nullptr");
        ...
        assert(m_pScoreManager != nullptr and "GameController::Test() m_pScoreManager is nullptr");
